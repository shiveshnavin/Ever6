...
import nf.co.thehoproject.ever6.adapters.RedeemWallAdapter;
import nf.co.thehoproject.ever6.utl;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link RedeemWall.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RedeemWall#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RedeemWall extends Fragment {
    ...
    public static ArrayList<Redeem> offers;
     ...
     * @return A new instance of fragment RedeemWall.
     */
    // TODO: Rename and change types and number of parameters
    public static RedeemWall newInstance(String param1, String param2) {
        RedeemWall fragment = new RedeemWall();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fire=new Firebase(Constants.FIREBASE_URL+"redeems");
        ...
        fire.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                offers=new ArrayList<Redeem>();
                for (DataSnapshot da: dataSnapshot.getChildren()) {

                    try {
                        Redeem of=new Redeem();
    ...
    public void showList(ArrayList<Redeem> offers)
    {

        RedeemWallAdapter adapter=new RedeemWallAdapter(offers,mListener);
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(Redeem offer, int pos);
    }
}
