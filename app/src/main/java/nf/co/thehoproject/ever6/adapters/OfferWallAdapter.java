...
public class OfferWallAdapter extends RecyclerView.Adapter<OfferWallAdapter.ViewHolder> {
    ...
    private final ArrayList<Offer> mValues;
    private final OfferWall.OnFragmentInteractionListener mListener;




    public OfferWallAdapter(ArrayList<Offer> items, OfferWall.OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                   ...
                   // utl.toast(ctx,holder.mItem.title);
